...
namespace Maze.Editor
{
    ...
    public class MazeWindow : EditorWindow
    {
        ...
        bool _createHoles = true;
        int _countObject = 1;
        float _radius = 10;
        float boxSize = 5f;
        int _matrixSideSize = 25;
        int matrixSize;
        MazePoint[,] m1;
        ...
        void OnGUI()
        {
            ...
            _createHoles = EditorGUILayout.BeginToggleGroup("Бурить стены", groupEnabled);
            _matrixSideSize = EditorGUILayout.IntSlider("Размер матрицы, длина", _matrixSideSize, 3, 10);
            matrixSize = _matrixSideSize * _matrixSideSize;
